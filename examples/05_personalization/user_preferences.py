...
Demonstrates how to use user preferences (optimization presets) to control routing behavior.
Conduit supports 4 optimization presets: balanced, quality, cost, and speed.

This is different from explicit_feedback.py which shows quality score submission.
This example focuses on optimization preferences (how to balance quality/cost/latency).
"""
