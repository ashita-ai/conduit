"""Settings class for Conduit configuration.
...
from conduit.core.config.utils import load_default_models, load_embeddings_config
...
class Settings(BaseSettings):
    ...
    log_format: str = Field(
        default="",
        description="Log format (json, console). Empty = auto-detect from environment",
    )
